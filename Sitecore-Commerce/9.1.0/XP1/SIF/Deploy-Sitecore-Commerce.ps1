...
param(
	...
	[string]$SqlDbPrefix = "$($SiteName)Sitecore",
...
$params = @{
		...
		CreateCommerceEngineClientCertificate				= "true"
		CommerceEngineCertificateName               		= "storefront.engine"
		CreateCommerceEngineServerCertificate				= "true"
		CommerceServicesHostPostfix                 		= "sc9.qa"
		CreateCommerceEngineLocalhostServerCertificate		= "true"		
		...
		XConnectInstallDir                          		= "c:\inetpub\wwwroot\$($SiteName)_xconnect"
		CommerceInstallRoot                         		= "c:\inetpub\wwwroot\"
		IdentityServerInstallRoot                   		= "c:\inetpub\wwwroot\"        
		...
		CommerceOpsServicesPrefix							= "CommerceOps_"
		CommerceShopsServicesPrefix							= "CommerceShops_"
		CommerceAuthoringServicesPrefix						= "CommerceAuthoring_"
		CommerceMinionsServicesPrefix						= "CommerceMinions_"
		CommerceOpsServicesHostPrefix						= "commerceops"
		CommerceShopsServicesHostPrefix						= "commerceshops"
		CommerceAuthoringServicesHostPrefix					= "commerceauthoring"
		CommerceMinionsServicesHostPrefix					= "commerceminions"
		...
		SitecoreConnectionPolicyHostName					= $SiteHostHeaderName
